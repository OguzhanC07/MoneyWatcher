    ...
    public class BudgetUpdateDtoValidation : AbstractValidator<BudgetUpdateDto>
    {
        public BudgetUpdateDtoValidation()
        {
            ...
            When(I => I.BudgetDate != null, () =>
            {
                ...
                When(I => I.BudgetDate.IsMonthly, () =>
                {
                    RuleFor(I => I.BudgetDate.FinishDate)
                        .NotNull().WithMessage("Finish date cannot be null or empty if is monthly type is true");
                });

                When(I => I.BudgetDate.IsMonthly == false, () =>
                {
                    RuleFor(I => I.BudgetDate.FinishDate).Null()
                        .WithMessage("Finish date must be null if is monthly type is false");
                });
            });
        }
    }
